...
duetScene_classic::duetScene_classic()
{
	music.init();
	time = 0;
	cursor_y = 294;
...
void duetScene_classic::update()
{
	update_time();
}

void duetScene_classic::update_time()
{
	time++;
	if (time > 60)
		time = 0;
...
bool duetScene_classic::isOver()
{
	return isover;
}

void duetScene_classic::onKey(key_msg key)
{
...
void duetScene_classic::rendMainface()
{
	int x, y;
...
void duetScene_classic::rendCursor()
{
